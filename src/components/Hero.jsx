  ...
  return (
    ...
    >
      <div className="w-full max-w-[1100px] mx-auto text-center">
        ...
        >
1MB Healthy is a hyper-personalized ABHA integrated, AI-
driven healthcare super app that integrates your entire
health journey — tracking, diagnosis, doctor support, and
preventive care — into one seamless platform. We are
redefining how individuals and doctors engage with personal
health data for better, faster, smarter healthcare outcomes.        </p>
